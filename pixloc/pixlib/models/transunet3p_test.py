...
class TransUnet3Plus(nn.Module):
    ...
    def __init__(self):
        ...
        self.h1_PT_hd4_conv = nn.Conv2d(self.filters[0], self.CatChannels, 3, padding=1)
        self.h1_PT_hd4_bn = nn.BatchNorm2d(self.CatChannels)
        self.h1_PT_hd4_relu = nn.ReLU(inplace=True)

        # h2->192*256, hd4->48*64
        self.h2_PT_hd4 = nn.MaxPool2d(4, 4, ceil_mode=True)
        self.h2_PT_hd4_conv = nn.Conv2d(self.filters[1], self.CatChannels, 3, padding=1)
        self.h2_PT_hd4_bn = nn.BatchNorm2d(self.CatChannels)
        self.h2_PT_hd4_relu = nn.ReLU(inplace=True)

        # h3->96*128, hd4->48*64
        self.h3_PT_hd4 = nn.MaxPool2d(2, 2, ceil_mode=True)
        self.h3_PT_hd4_conv = nn.Conv2d(self.filters[2], self.CatChannels, 3, padding=1)
        self.h3_PT_hd4_bn = nn.BatchNorm2d(self.CatChannels)
        self.h3_PT_hd4_relu = nn.ReLU(inplace=True)

        # h4->48*64, hd4->48*64
        self.h4_Cat_hd4_conv = nn.Conv2d(self.filters[3], self.CatChannels, 3, padding=1)
        self.h4_Cat_hd4_bn = nn.BatchNorm2d(self.CatChannels)
        self.h4_Cat_hd4_relu = nn.ReLU(inplace=True)

        # hd5->24*32, hd4->48*64
        self.hd5_UT_hd4 = nn.Upsample(scale_factor=2, mode=self.bilinear)  # 14*14
        self.hd5_UT_hd4_conv = nn.Conv2d(self.filters[4], self.CatChannels, 3, padding=1)
        ...
        self.h1_PT_hd3_conv = nn.Conv2d(self.filters[0], self.CatChannels, 3, padding=1)
        self.h1_PT_hd3_bn = nn.BatchNorm2d(self.CatChannels)
        self.h1_PT_hd3_relu = nn.ReLU(inplace=True)

        # h2->192*256, hd3->96*128
        self.h2_PT_hd3 = nn.MaxPool2d(2, 2, ceil_mode=True)
        self.h2_PT_hd3_conv = nn.Conv2d(self.filters[1], self.CatChannels, 3, padding=1)
        self.h2_PT_hd3_bn = nn.BatchNorm2d(self.CatChannels)
        self.h2_PT_hd3_relu = nn.ReLU(inplace=True)

        # h3->96*128, hd3->96*128
        self.h3_Cat_hd3_conv = nn.Conv2d(self.filters[2], self.CatChannels, 3, padding=1)
        ...
        self.hd5_UT_hd3_conv = nn.Conv2d(self.filters[4], self.CatChannels, 3, padding=1)
        ...
        self.h1_PT_hd2_conv = nn.Conv2d(self.filters[0], self.CatChannels, 3, padding=1)
        self.h1_PT_hd2_bn = nn.BatchNorm2d(self.CatChannels)
        self.h1_PT_hd2_relu = nn.ReLU(inplace=True)

        # h2->192*256, hd2->192*256
        self.h2_Cat_hd2_conv = nn.Conv2d(self.filters[1], self.CatChannels, 3, padding=1)
        ...
        self.hd5_UT_hd2_conv = nn.Conv2d(self.filters[4], self.CatChannels, 3, padding=1)
        ...
        self.h1_Cat_hd1_conv = nn.Conv2d(self.filters[0], self.CatChannels, 3, padding=1)
        ...
        self.hd5_UT_hd1_conv = nn.Conv2d(self.filters[4], self.CatChannels, 3, padding=1)
        ...
        self.outconv3 = nn.Conv2d(self.filters[-1], 128, 1)

        # uncertainty
        self.uncer1=nn.Conv2d(320,1,1,1)
        self.uncer2=nn.Conv2d(320,1,1,1)
        self.uncer3=nn.Conv2d(self.filters[-1],1,1,1)
    ...
    def forward(self, inputs):
        ...
        hd5=self.flatten1(hd5)
        B,C,H,W=hd5.shape
        hd5 = hd5.flatten(2)
        hd5 = hd5.transpose(-1, -2)  # (B, n_patches, hidden
        hd5,H,W=self.swin_block(hd5,H,W)
        hd5=hd5.view(B, H, W, -1).permute(0,3,1,2)
        hd5=self.flatten2(hd5)
